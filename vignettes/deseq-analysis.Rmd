...
suppressPackageStartupMessages({
  devtools::load_all()
  # library(lf.hypoxia.molidustat.rnaseq)
  library(tidyverse)
  library(patchwork)
  library(DESeq2)
})
...
We will use the `DESeq2` package to identify differentially expresssed genes. We will use the model `~ oxygen * treatment`. 
...
labs <- 
  ...
  left_join(pheno_data, by = c("label" = "id"))
...
df <- 
  ...
  left_join(pheno_data, by = c("sample_1" = "id")) %>% 
  mutate(
